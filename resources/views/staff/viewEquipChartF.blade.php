...
<div class="col-10 mx-auto my-5 bg-light rounded">
    <input type="hidden" name="year" id="facultyID" value="{{$facultyID}}">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-sm-3"><label for="">Year</label>
                        ...
                        <input type="hidden" name="year" id="facultyID" value="{{$facultyID}}" class="form-control mb-3" required>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        $("select#filter").change(function() {
            ...
            $.ajax({
                url: '{{route("filter.item_monthly_chart") }}',
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
