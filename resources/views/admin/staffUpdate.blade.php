            ...
            <div class="card mb-5">
                <div class="card-body d-flex flex-column ">
                    ...
                    <div class="col-10 mx-auto">
                        ...
                        <form class="text-center" action="/admin/updateStaff/{{$staffId}}" method="post">
                            @csrf
                            ...
                            @enderror
                            <input class="form-control" name="employeenum" value="{{$staffId}}" readonly placeholder="Enter Full Name" />
                        </div>
                            <div class="mb-3" align="left">
