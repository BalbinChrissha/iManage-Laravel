...
<div style="width: 100%; background-color: #89BBEA; position: sticky; top: 0; z-index: 1;" class="sticky-top p-0">
        ...
        <div style=" background-color: #89BBEA; height: 40px; padding: 8px;" class="col-11 mx-auto">
            <div class="row">
                <div class="col-6">
                    <i class="fa-solid fa-user"></i> Admin &nbsp; <b>|</b>&nbsp; <b><?php echo e(Session::get('adminName')); ?></b>
                </div>
...
<?php /**PATH C:\xampp\htdocs\iManageWS2\resources\views/template/adminNavbar.blade.php ENDPATH**/ ?>