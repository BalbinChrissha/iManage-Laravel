...
<div class="container" style="margin-top: 2%;">
    <div class="div1">
        ...
        <div class="col-sm-9 mx-auto">
            <form action="/faculty/updateInventoryStateReport/<?php echo e($stateID); ?>/<?php echo e($checkedID); ?>/<?php echo e($recordno); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-lg-6">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <label for="">Qty: Consumed</label> <?php $__errorArgs = ['unavailable1_qty'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-lg-6">
                        <label for="">Qty: Expired (Perishable Items Only)</label> <?php $__errorArgs = ['unavailable2_qty'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        <input type="number" name="year" value="<?php echo e($year); ?>" id="year" class="form-control mb-3" readonly>
                    </div>
...
<?php echo $__env->make('template.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iManageWS2\resources\views/faculty/updateSuppMReport.blade.php ENDPATH**/ ?>