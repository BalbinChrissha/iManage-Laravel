                ...
                <table id="table_id" class="display">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="/admin/editAdmin/<?php echo e($admin -> adminID); ?>"><i input type="edit" class="fa-solid fa-pen-to-square" style="color:blue;"></i></a> &nbsp; <a href="/admin/delAdmin/<?php echo e($admin -> adminID); ?>"><i input type="submit" class="fas fa-trash-alt" style="color:red;"></i> </a></td>
                        </tr>
...
<?php echo $__env->make('template.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iManageWS2\resources\views/admin/manageAdmin.blade.php ENDPATH**/ ?>