...
<div class="col-10 mx-auto my-5 bg-light rounded">
    <input type="hidden" name="year" id="facultyID" value="<?php echo e(Session::get('facultyId')); ?>">
    <input type="hidden" name="year" id="recorID" value="<?php echo e($recordno); ?>">

    <div class="col-sm-12 mx-auto p-5">
        <center>
            <h3 id="title"><b>ITEM <?php echo e(mb_strtoupper($item_name)); ?> : REPORT FOR THE YEAR OF <?php echo e($year); ?></b></h3>
        </center><br>
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-sm-3"><label for="">Year</label>
                        ...
                        <input type="hidden" id="facultyID" value="<?php echo e(Session::get('facultyId')); ?>" class="form-control mb-3" required>
                    </div>
                </div>
            </div>
        </div>
...
<script>
        ...
        $("select#filter").change(function() {
           ...
           // alert(inputValue + " " + facultyno + " " + recordno + " " + selectedfilter);
            ...
            $.ajax({
                url: '<?php echo e(route("filter.item_monthly_chart2")); ?>',
                type: 'POST',
                data: {
...
<?php echo $__env->make('template.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iManageWS2\resources\views/faculty/viewSuppDataChart.blade.php ENDPATH**/ ?>