            ...
            <div class="col-md">
                <div class="row">
                    ...
                    <div class="col-sm-3"><label for="">Year</label>
                        ...
                        <input type="hidden" name="year" id="staffID" value="<?php echo e(Session::get('sosId')); ?>" class="form-control mb-3" required>
                    </div>
                ...
                <table id="table_id1" class="display">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($record -> totaltransfer); ?></td>
...
<script>
    $(document).ready(function() {
        $('#filterbutton').click(function() {
            ...
            $.ajax({
                url: '<?php echo e(route("filter.staff_filter_item")); ?>',
...
<?php echo $__env->make('template.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iManageWS2\resources\views/staff/sFilterInventory.blade.php ENDPATH**/ ?>