            ...
            <div class="card mb-5">
                <div class="card-body d-flex flex-column ">
                    ...
                    <div class="col-10 mx-auto">
                        ...
                        <form class="text-center" action="/admin/updateStaff/<?php echo e($staffId); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            <input class="form-control" name="employeenum" value="<?php echo e($staffId); ?>" readonly placeholder="Enter Full Name" />
                        </div>
                            <div class="mb-3" align="left">
...
<?php echo $__env->make('template.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iManageWS2\resources\views/admin/staffUpdate.blade.php ENDPATH**/ ?>